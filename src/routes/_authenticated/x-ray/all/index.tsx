      ...
      try {
        ...
        const testCards = xrayTests.map((test: any) => `
          <div class="border rounded-xl p-4 hover:shadow-md transition bg-gray-50">
            ...
            <div class="flex gap-2 pt-3 border-t">
              <a href="/x-ray/all/edit/builder/${test.serial_id || test.id}" class="inline-flex items-center justify-center rounded-lg text-sm font-medium bg-green-600 text-white hover:bg-green-700 h-8 px-4 transition shadow-sm">
                Edit
              </a>
              <a href="/x-ray/all/print/${test.serial_id || test.id}" class="inline-flex items-center justify-center rounded-lg text-sm font-medium bg-blue-600 text-white hover:bg-blue-700 h-8 px-4 transition shadow-sm">
                Print
              </a>
            </div>
          </div>
        ...
        let htmlContent = `
          ...
          <div class="px-6 py-4 bg-gray-50 flex justify-end gap-3">
            <a href="/x-ray/all/edit/${reciptId}"
