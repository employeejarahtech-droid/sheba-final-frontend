...
export const Route = createFileRoute('/_authenticated/dashboard/outdoor/master/departments/$id')({
    ...
    if (error) {
        return (
            <div className='flex h-screen w-full flex-col items-center justify-center gap-4 bg-background'>
                ...
                <Button variant="outline" onClick={() => navigate({ to: '/dashboard/outdoor/master/departments' })}>
        ...
        <>
            ...
            <Main className='bg-muted/10'>
                <PageHeader
                    ...
                    backButton={{
                        onClick: () => navigate({ to: '/dashboard/outdoor/master/departments' }),
                        variant: 'outline',
                    ...
                    actions={
                        <>
                            ...
                            <Button size="sm" variant="default" className='shadow-md' onClick={() => navigate({ to: '/dashboard/outdoor/master/departments' })}>
