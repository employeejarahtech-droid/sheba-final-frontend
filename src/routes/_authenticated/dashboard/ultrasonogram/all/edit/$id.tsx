...
function EditUltrasonogramReport() {
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      router.navigate({ to: '/dashboard/ultrasonogram/all' });
    },
  });
  ...
  //   router.navigate({ to: '/dashboard/ultrasonogram/all/print/$id', params: { id } });
  // };
    ...
    <AppHeader fixed />
      ...
      <Main>
        <div className="flex items-center justify-between gap-4 mb-6">
          ...
          <Link to="/dashboard/all" className="ms-auto">
