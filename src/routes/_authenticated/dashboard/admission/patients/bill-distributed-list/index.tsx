...
const billDistributedSearchSchema = z.object({
...
export const Route = createFileRoute('/_authenticated/dashboard/admission/patients/bill-distributed-list/')({
    validateSearch: (search) => billDistributedSearchSchema.parse(search),
    component: BillDistributedCompleteListPage,
})

function BillDistributedCompleteListPage() {
    ...
    return (
        <BillsDistributedListPage
            ...
            providerPaymentStatus="complete"
        />
    );
}
