...
const billNotCreatedSearchSchema = z.object({
...
export const Route = createFileRoute('/_authenticated/dashboard/admission/discharged-patients/bill-does-not-created/')({
    validateSearch: (search) => billNotCreatedSearchSchema.parse(search),
    component: BillNotCreatedPage,
})

function BillNotCreatedPage() {
