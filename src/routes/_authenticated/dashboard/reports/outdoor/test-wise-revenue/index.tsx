...
import { Users, DollarSign, Banknote, AlertCircle, Hash, Printer, FileText } from 'lucide-react'
...
function TestWiseRevenueReport() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['outdoor-test-wise-revenue', page, limit, search, from, to],
    queryFn: async () => {
      ...
      if (!res.ok) throw new Error('Failed to fetch test-wise revenue')
      return res.json()
    },
    enabled: !!token,
  ...
  return (
    <>
      <AppHeader
        title="Test-wise Revenue Report"
        description="Revenue breakdown by outdoor invoices with filtering, search, and detailed statistics"
        fixed
      />
      ...
      <main className="">
        ...
        <DataTable
          tableTitle="Test-wise Revenue List"
          columns={columns}
          data={items}
          meta={meta}
          ...
          filterSlot={
            <div className="flex items-center gap-1.5">
              ...
              <Link
                to="/dashboard/reports/outdoor/test-wise-revenue/print"
                search={{
          ...
          emptyState={
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 font-medium">No invoice records found</p>
