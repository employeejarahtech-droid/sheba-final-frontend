...
import { Users, DollarSign, TrendingDown, Banknote, Printer, FileText, User } from 'lucide-react'
...
function OutdoorPatientListPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['outdoor-patient-list', page, limit, search, from, to],
    queryFn: async () => {
  ...
  return (
    <>
      <AppHeader
        ...
        description="Complete record of outdoor patient invoices with billing summary"
        fixed
      />

      <main className="">
        {/* Enhanced Stats Cards - 4 cards in 2 rows */}
        ...
        <DataTable
          tableTitle="Outdoor Patient List"
          columns={columns}
          data={items}
          meta={meta}
          ...
          filterSlot={
            <div className="flex items-center gap-1.5">
              ...
              <Link
                to="/dashboard/reports/outdoor/patient-list/print"
                search={{
          ...
          emptyState={
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 font-medium">No outdoor patient records found</p>
