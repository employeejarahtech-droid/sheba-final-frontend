...
import { TrendingDown, AlertCircle, DollarSign, Clock, Printer, FileText, Calendar } from 'lucide-react'
...
function DueCollectionPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['due-collection', page, limit, search, from, to],
    queryFn: async () => {
  ...
  const stats = useMemo(() => {
    ...
    const oldest = items.length > 0
      ? items.reduce((a, b) => new Date(a.created_at || '') < new Date(b.created_at || '') ? a : b)
      : null
          ...
          <div class="space-y-6">
            <div class="grid grid-cols-2 gap-x-8 gap-y-4 text-sm border-b pb-6">
              ...
              <div>
                ...
                <p class="font-semibold text-gray-800">${formatDateTime(invoice.created_at)}</p>
              </div>
            </div>

            <div class="flex justify-end gap-3 pt-4 border-t">
              <a href="/dashboard/outdoor-invoice/print/${id}"
                 class="inline-flex items-center justify-center rounded-lg text-sm font-medium border border-gray-300 bg-white hover:bg-gray-100 h-10 px-5 transition">
                Print Invoice
              </a>
              <a href="/dashboard/outdoor-invoice/${id}"
    ...
    },
    {
      ...
      render: (_data: any, _type: string, row: DueCollectionItem) => {
        ...
        return `<div class="flex gap-2">
          <a href="/dashboard/outdoor-invoice/print/${id}" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded text-xs font-semibold shadow transition-colors">
  ...
  return (
    <>
      <AppHeader
        ...
        description="Outdoor invoices with outstanding balances and payment tracking"
        fixed
      />
        ...
        <DataTable
          ...
          filterSlot={
            <div className="flex items-center gap-1.5">
              ...
              <Link
                to="/dashboard/reports/outdoor/due-collection/print"
                search={{
