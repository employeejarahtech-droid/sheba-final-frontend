...
import { BarChart3, Building2, DollarSign, TrendingDown, Printer, FileText, Calendar, Users, Wallet, Receipt, AlertCircle } from 'lucide-react'
...
function ServiceWiseRevenuePage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['service-wise-revenue', page, limit, search, from, to],
    queryFn: async () => {
  ...
  return (
    <>
      <AppHeader
        ...
        description="Indoor revenue analysis by ward/service with comprehensive filtering"
        fixed
      />
      ...
      <main className="">
        ...
        <DataTable
          tableTitle="Service-wise Revenue List"
          columns={columns}
          data={items}
          meta={meta}
          ...
          filterSlot={
            <div className="flex items-center gap-1.5">
              ...
              <Link
                to="/dashboard/reports/indoor/service-wise-revenue/print"
                search={{
          ...
          emptyState={
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 font-medium">No service-wise revenue records found</p>
