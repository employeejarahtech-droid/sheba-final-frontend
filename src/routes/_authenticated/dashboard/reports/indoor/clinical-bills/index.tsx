...
export const Route = createFileRoute('/_authenticated/dashboard/reports/indoor/clinical-bills/')({
  validateSearch: (search) => clinicalBillsSearchSchema.parse(search),
  component: ClinicalBillsPage,
})

function ClinicalBillsPage() {
  ...
  const { data, isLoading } = useQuery<{
    ...
    queryKey: ['clinical-bills-report', page, limit, search, from, to],
    queryFn: async () => {
  ...
  const providerName = (r: ClinicalBillItem) => r.service_name || 'Unspecified'
  ...
  // Service-wise analysis (current page)
  ...
  const columns = [
    {
      ...
      render: (_: any, __: string, row: any) => {
        ...
        return `<div class="font-medium">${r.service}</div>`
      },
    },
    {
      data: 'count',
  ...
  return (
    <>
      <AppHeader
        title="Clinical Bills Report"
        description="Clinical service-wise analysis of indoor clinical service distributions"
        fixed
      />
      ...
      <main className="">
        ...
        <DataTable
          tableTitle="Clinical Service-wise Breakdown"
          columns={columns}
          data={serviceRows}
          meta={meta}
          ...
          filterSlot={
            <div className="flex items-center gap-1.5">
              ...
              <Link
                to="/dashboard/reports/indoor/clinical-bills/print"
                search={{
          ...
          emptyState={
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 font-medium">No clinical bills records found</p>
