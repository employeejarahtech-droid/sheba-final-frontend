...
export const Route = createFileRoute('/_authenticated/dashboard/reports/indoor/anesthesia-bill/')({
  validateSearch: (search) => anesthesiaBillSearchSchema.parse(search),
  component: AnesthesiaBillPage,
})

function AnesthesiaBillPage() {
  ...
  const { data, isLoading } = useQuery<{
    ...
    queryKey: ['anesthesia-bill-report', page, limit, search, from, to],
    queryFn: async () => {
  ...
  return (
    <>
      <AppHeader
        title="Anesthesia Bill Report"
        description="Anesthesiologist-wise analysis of indoor anesthesia bill distributions"
        fixed
      />
      ...
      <main className="">
        ...
        <DataTable
          tableTitle="Anesthesiologist-wise Breakdown"
          columns={columns}
          data={providerRows}
          meta={meta}
          ...
          filterSlot={
            <div className="flex items-center gap-1.5">
              ...
              <Link
                to="/dashboard/reports/indoor/anesthesia-bill/print"
                search={{
          ...
          emptyState={
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 font-medium">No anesthesia bill records found</p>
