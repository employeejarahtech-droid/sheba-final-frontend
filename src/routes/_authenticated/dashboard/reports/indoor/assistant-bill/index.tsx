...
const assistantBillSearchSchema = z.object({
...
export const Route = createFileRoute('/_authenticated/dashboard/reports/indoor/assistant-bill/')({
  validateSearch: (search) => assistantBillSearchSchema.parse(search),
  component: AssistantBillPage,
})

function AssistantBillPage() {
  ...
  const { data, isLoading } = useQuery<{
    ...
    queryKey: ['assistant-bill-report', page, limit, search, from, to],
    queryFn: async () => {
  ...
  return (
    <>
      <AppHeader
        title="Assistant Bill Report"
        description="Assistant-wise analysis of indoor assistant bill distributions"
        fixed
      />
      ...
      <main className="">
        ...
        <DataTable
          tableTitle="Assistant-wise Breakdown"
          columns={columns}
          data={providerRows}
          meta={meta}
          ...
          filterSlot={
            <div className="flex items-center gap-1.5">
              ...
              <Link
                to="/dashboard/reports/indoor/assistant-bill/print"
                search={{
          ...
          emptyState={
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 font-medium">No assistant bill records found</p>
