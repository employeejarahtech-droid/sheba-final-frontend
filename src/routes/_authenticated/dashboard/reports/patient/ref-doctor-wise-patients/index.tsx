...
function DoctorWisePatientsPage() {
  ...
  return (
    <>
      <AppHeader
        title="Doctor-wise Patient Report"
        description="Patient distribution and revenue collection by referring doctor with filtering and statistics"
        fixed
      />
      ...
      <main className="">
        ...
        <DataTable
          tableTitle="Doctor-wise Patient List"
          columns={columns}
          data={items}
          meta={meta}
          ...
          emptyState={
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 font-medium">No doctor records found</p>
