...
function AssetLocationsPage() {
    const can = useCan();
    const canEdit = can('assets.locations.edit');
    ...
    },
    {
      ...
      render: (_d: any, _t: string, row: any) => `
        <div class="flex gap-2">
          ${canEdit ? `<a href="/dashboard/assets/locations/edit/${row.id}" class="inline-flex items-center justify-center rounded-md text-sm font-medium border border-input bg-background hover:bg-accent h-8 px-3">Edit</a>` : ''}
