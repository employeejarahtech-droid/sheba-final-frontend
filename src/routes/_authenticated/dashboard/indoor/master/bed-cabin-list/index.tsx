...
function BedCabinList() {
    ...
    const can = useCan();
    const canCreate = can('indoor.master.beds-cabins.create');
    const canEdit = can('indoor.master.beds-cabins.edit');
    const canDelete = can('indoor.master.beds-cabins.delete');
