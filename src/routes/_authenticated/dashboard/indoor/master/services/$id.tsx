...
export const Route = createFileRoute('/_authenticated/dashboard/indoor/master/services/$id')({
    ...
    if (error) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen gap-4">
                ...
                <Button variant="outline" onClick={() => navigate({ to: '/dashboard/indoor/master/services' })}>
                    Back to Services
                </Button>
            </div>
        )
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                            <Button
                                variant="ghost"
                                className="gap-2"
                                onClick={() => service && navigate({ to: `/dashboard/master/services/edit/${service.id}` })}
                                disabled={!service}
                            >
