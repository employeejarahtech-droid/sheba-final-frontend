    ...
    <>
      ...
      <Main>
        <div className="print:hidden flex items-center justify-between gap-4">
          <Link to="/dashboard/pathology/biochemical/lipid-profile">
        ...
        <ReportDetails invoice={invoice} testName="Lipid Profile Report" paddingTop={paddingTop} fontSize={FONT_SIZE_OPTIONS[fontSize].zoom} showSignature={showSignature} />
        <EditLipidProfileForm open={editOpen} setOpen={setEditOpen} reportId={Number(reportId)} invoiceId={Number(invoice?.invoice_id || 0)} />
      </Main>
    </>
  )
}
