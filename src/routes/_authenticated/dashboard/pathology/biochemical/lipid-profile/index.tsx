...
import { Activity, Clock, FileText, AlertCircle, Check, Filter } from 'lucide-react';
    ...
    const handleExpandClick = async (e: Event) => {
      ...
      let htmlContent = `
        ...
        <div class="px-6 py-4 bg-gray-50 flex justify-end gap-3">
          ...
          ${canEdit ? `<button onclick="window.editLipidProfile(${reportId}, ${invoiceId})"
      ...
      render: (_data: any, _type: string, row: LipidProfileItem) => {
        return `
          <div class="flex flex-nowrap items-center gap-2">
            ${canEdit ? `<button type="button" onclick="window.editLipidProfile(${row.id}, ${row.invoice_id})" title="Edit"
            ...
            <a href="/dashboard/pathology/biochemical/lipid-profile/report/${row.id}" title="Print / view report"
