        ...
        <>
            ...
            <Main>
                <div className="print:hidden flex items-center justify-between gap-4">
                    <Link to="/dashboard/pathology/biochemical/all">
                    ...
                    <div className="flex items-center gap-3">
                        <Link to="/dashboard/pathology/biochemical/all/edit/$reportId" params={{ reportId }}>
                ...
                <BiochemistryReport invoice={invoice} testName="Biochemistry Report" paddingTop={paddingTop} fontSize={FONT_SIZE_OPTIONS[fontSize].zoom} showSignature={showSignature} columnLayout={columnLayout} />
            </Main>
        </>
    )
}
