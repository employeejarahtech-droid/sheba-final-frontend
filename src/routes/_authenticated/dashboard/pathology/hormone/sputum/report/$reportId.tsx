    ...
    return (
        <>
            ...
            <Main>
                ...
                <SputumReportDetails sputumData={sputumData} invoiceData={invoiceData} paddingTop={paddingTop} fontSize={FONT_SIZE_OPTIONS[fontSize].zoom} showSignature={showSignature} />
            </Main>
        </>
    )
}
