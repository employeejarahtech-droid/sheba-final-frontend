...
function Electrolytes() {
  ...
  const { data: electrolytesReports, isFetching } = useQuery({
    queryKey: ["electrolytes", page, limit, search, statusFilter, from, to],
    queryFn: async () => {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/electrolytes?page=${page}&limit=${limit}&search=${encodeURIComponent(search)}${statusParam}${fromParam}${toParam}`,
        {
