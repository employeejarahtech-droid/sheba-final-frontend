    ...
    return (
        <>
            ...
            <Main>
                ...
                <T3T4TSHReportDetails t3t4tshData={t3t4tshData} invoiceData={invoiceData} paddingTop={paddingTop} fontSize={FONT_SIZE_OPTIONS[fontSize].zoom} showSignature={showSignature} />
            </Main>
        </>
    )
}
