        ...
        <>
           <AppHeader fixed />
            <Main>
                ...
                <SkinScrappingForFungusReportDetails skinScrappingData={skinScrappingData} invoiceData={invoiceData} paddingTop={paddingTop} fontSize={FONT_SIZE_OPTIONS[fontSize].zoom} showSignature={showSignature} />
            </Main>
        </>
    )
}
