    ...
    return (
        <>
            ...
            <Main>
                ...
                <SemenReportDetails semenData={semenData} invoiceData={invoiceData} paddingTop={paddingTop} fontSize={FONT_SIZE_OPTIONS[fontSize].zoom} showSignature={showSignature} />
            </Main>
        </>
    )
}
