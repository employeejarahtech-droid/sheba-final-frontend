...
function WidalTest() {
  ...
  const { data, isFetching } = useQuery({
    queryKey: ["widal", page, limit, search, statusFilter, from, to],
    ...
    queryFn: async () => {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/widal?page=${page}&limit=${limit}&search=${encodeURIComponent(search)}${statusParam}${fromParam}${toParam}`,
        {
