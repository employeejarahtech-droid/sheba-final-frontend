...
function PeripheralBloodFilm() {
  ...
  const { data, isFetching } = useQuery({
    queryKey: ["peripheral-blood", page, limit, search, statusFilter, from, to],
    ...
    queryFn: async () => {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/peripheral-blood?page=${page}&limit=${limit}&search=${encodeURIComponent(search)}${statusParam}${fromParam}${toParam}`,
        {
