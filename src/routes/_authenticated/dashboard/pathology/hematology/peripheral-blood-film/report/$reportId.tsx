    ...
    return (
        <>
            ...
            <Main>
                ...
                <PeripheralBloodFilmReportDetails invoice={invoice} testName="Peripheral Blood Film (PBF) Report" paddingTop={paddingTop} fontSize={FONT_SIZE_OPTIONS[fontSize].zoom} showSignature={showSignature} />
            </Main>
        </>
    )
}
