...
function AllReportsHematology() {
    const can = useCan();
    const canEdit = can('pathology.hematology.all.edit');
    ...
    const handleExpandClick = async (e: Event) => {
      ...
      let htmlContent = `
        ...
        <div class="px-6 py-4 bg-gray-50 flex justify-end gap-3">
          ...
          ${canEdit ? `<a href="/dashboard/pathology/hematology/all/edit/${reciptId}"
      ...
      render: (_data: any, _type: string, row: ReportsItem) => {
        ...
        return `
          <div class="flex flex-nowrap items-center gap-2">
            ${canEdit ? `<a href="/dashboard/pathology/hematology/all/edit/${id}" title="Edit report"
            ...
            <a href="/dashboard/pathology/hematology/all/report/${id}" title="Print / view report"
