    ...
    return (
        <>
            ...
            <Main>
                ...
                <BloodForBtctReportDetails invoice={invoice} testName="Blood For BT/CT Report" paddingTop={paddingTop} fontSize={FONT_SIZE_OPTIONS[fontSize].zoom} showSignature={showSignature} />
            </Main>
        </>
    )
}
