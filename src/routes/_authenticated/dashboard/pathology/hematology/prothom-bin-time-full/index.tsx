...
function ProthomBinTimeFull() {
  ...
  const { data, isFetching } = useQuery({
    queryKey: ["prothombin-time", page, limit, search, statusFilter, from, to],
    ...
    queryFn: async () => {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/prothombin-time?page=${page}&limit=${limit}&search=${encodeURIComponent(search)}${statusParam}${fromParam}${toParam}`,
        {
