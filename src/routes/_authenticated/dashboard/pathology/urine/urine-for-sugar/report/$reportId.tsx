  ...
  return (
    <>
      ...
      <Main>
        ...
        <UrineForSugarFullReportDetails report={report} invoice={invoice} paddingTop={paddingTop} fontSize={FONT_SIZE_OPTIONS[fontSize].zoom} showSignature={showSignature} />
      </Main>
    </>
  )
}
