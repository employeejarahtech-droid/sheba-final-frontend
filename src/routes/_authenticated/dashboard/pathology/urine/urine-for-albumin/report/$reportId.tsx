...
function UrineForAlbuminReport() {
  ...
  return (
    ...
    <AppHeader fixed />
      ...
      <UrineForAlbuminReportDetails urineAlbuminData={urineAlbuminData} invoiceData={invoiceData} paddingTop={paddingTop} fontSize={FONT_SIZE_OPTIONS[fontSize].zoom} showSignature={showSignature} />
        </Main>
    </>
  )
}
