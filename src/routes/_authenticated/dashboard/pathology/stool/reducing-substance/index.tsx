...
function ReducingSubstance() {
  ...
  const { data, isFetching } = useQuery({
    queryKey: ["reducing-substance", page, limit, search, statusFilter, from, to],
    ...
    queryFn: async () => {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/reducing-substance?page=${page}&limit=${limit}&search=${encodeURIComponent(search)}${statusParam}${fromParam}${toParam}`,
        {
