...
import AddProductCategoryForm from "@/features/products/categories/AddProductCategoryForm";
import EditProductCategoryForm from "@/features/products/categories/EditProductCategoryForm";
import { CheckCircle, Layers, XCircle } from "lucide-react";
import { toast } from "sonner";
import { useCategories, useAllCategories, useDeleteCategory } from "@/features/products/api/categoryQueries";
...
function CategoryPage() {
  ...
  const activeCategories = allCategories.filter((c: Category) => c.is_active).length;
  const inactiveCategories = allCategories.filter((c: Category) => !c.is_active).length;
