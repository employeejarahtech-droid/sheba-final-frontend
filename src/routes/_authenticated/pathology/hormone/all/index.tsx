  ...
  return (
    <>
      ...
      <Main>
        ...
        <DataTable columns={columns} data={hormoneAllReports?.data?.items || []} meta={hormoneAllReports?.data?.meta} onPageChange={setPage} search={search} onSearchChange={setSearch} />
      </Main>
    </>
