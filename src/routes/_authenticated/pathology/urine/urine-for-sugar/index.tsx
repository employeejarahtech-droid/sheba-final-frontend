    ...
    const handleExpandClick = async (e: Event) => {
      ...
      const statusBadge = status === 'Completed'
        ...
        : status === 'Pending'
          ...
          : '<span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-700">Pending</span>';
      ...
      let htmlContent = `
        ...
        <div class="px-6 py-4 bg-gray-50 flex justify-end gap-3">
          <a href="/pathology/urine/urine-for-sugar/report/${reportId}"
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-600 to-amber-400 p-6 shadow-lg shadow-amber-500/30 transition-all duration-300 hover:scale-[1.02] hover:translate-y-[-2px]">
              ...
              <div className="relative flex items-start justify-between mb-4">
                <div>
                  ...
                  <h3 className="mt-2 text-2xl font-bold text-white">{urineSugarData?.data?.meta?.total || 0}</h3>
                </div>
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-600 to-orange-400 p-6 shadow-lg shadow-orange-500/30 transition-all duration-300 hover:scale-[1.02] hover:translate-y-[-2px]">
              ...
              <div className="relative flex items-start justify-between mb-4">
                <div>
                  <p className="text-sm font-medium text-white/90 uppercase tracking-widest">Sugar Tests</p>
                  <h3 className="mt-2 text-2xl font-bold text-white">{urineSugarData?.data?.items?.length || 0}</h3>
                </div>
                <div className="rounded-xl bg-white/20 p-2.5 backdrop-blur-sm">
              ...
              <div className="relative flex items-start justify-between mb-4">
                <div>
                  ...
                  <h3 className="mt-2 text-2xl font-bold text-white">
                    {urineSugarData?.data?.items?.filter((i: any) => {
            ...
            {/* Patients */}
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-700 to-amber-500 p-6 shadow-lg shadow-amber-600/30 transition-all duration-300 hover:scale-[1.02] hover:translate-y-[-2px]">
              <div className="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-white/10 blur-2xl" />
              <div className="absolute -bottom-6 -left-6 h-24 w-24 rounded-full bg-black/10 blur-2xl" />
              <div className="relative flex items-start justify-between mb-4">
                <div>
                  <p className="text-sm font-medium text-white/90 uppercase tracking-widest">Patients</p>
                  <h3 className="mt-2 text-2xl font-bold text-white">{new Set(urineSugarData?.data?.items?.map((i: any) => i.patient_name)).size || 0}</h3>
                </div>
                <div className="rounded-xl bg-white/20 p-2.5 backdrop-blur-sm">
