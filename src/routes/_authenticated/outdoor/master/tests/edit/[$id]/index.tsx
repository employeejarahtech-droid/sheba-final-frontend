...
import { Check, ChevronDown, ArrowLeft, CircleCheck, PenLine, FlaskConical, Grip, LayoutTemplate, Activity, DollarSign } from 'lucide-react';
                    ...
                    <div className="flex flex-col items-center justify-center h-[calc(100vh-100px)]">
                        <div className="relative">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <FlaskConical className="h-6 w-6 text-blue-600 animate-pulse" />
                            </div>
                        </div>
                        <p className="mt-4 text-lg font-medium text-gray-500 animate-pulse">Loading test data...</p>
                    </div>
                </Main>
            </div>
        )
                ...
                <Main>
                    <div className="flex flex-col items-center justify-center h-[calc(100vh-100px)] text-center px-4">
                        <div className="rounded-full bg-red-100 p-6 mb-6 shadow-lg shadow-red-100/50">
                            <FlaskConical className="h-12 w-12 text-red-600" />
                        </div>
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Test Not Found</h3>
                        <Button
                            variant="outline"
        ...
        <div className="flex flex-col min-h-screen bg-gray-50/50 dark:bg-background">
            ...
            <Main className="p-6 lg:p-10 w-full flex-1">
                <div className="space-y-8 max-w-5xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 dark:border-gray-800 pb-8">
                        <div>
                            ...
                            <p className="text-muted-foreground mt-1 text-sm font-medium">
                                Update diagnostic details and pricing for ID: {id}
                            </p>
                        </div>
                    ...
                    <Form {...form}>
                        <form id="edit-test-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                                    ...
                                    <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-blue-50 dark:from-blue-950/30 dark:via-indigo-950/30 dark:to-blue-950/30 px-6 py-4 flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <CardDescription className="text-sm text-gray-600 dark:text-gray-400 mt-0.5">
                                                Core diagnostic parameters and pricing
                                            </CardDescription>
                                        </div>
                                    </div>
                                </CardHeader>
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    <Check
                                                                                        className={cn(
                                                                                            ...
                                                                                            Number(item.id) === Number(field.value) ? "opacity-100" : "opacity-0"
                                                                                        )}
                                                                                    />
                                                                                </CommandItem>
                                                                            ))}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem className="flex flex-col gap-2">
                                                    ...
                                                    <FormDescription className="text-[10px] text-muted-foreground mt-0">
                                                        Current operational status of this test.
                                                    </FormDescription>
                                                    <FormMessage className="text-[10px]" />
                                                </FormItem>
                                            )}
