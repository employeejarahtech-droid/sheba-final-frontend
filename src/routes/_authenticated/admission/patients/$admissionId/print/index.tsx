...
export const Route = createFileRoute('/_authenticated/admission/patients/$admissionId/print/')({
                    ...
                    <div className="text-center border-b-2 border-blue-600 pb-6 mb-6">
                        <div className="flex items-center justify-center gap-3 mb-3">
                            ...
                            <div className="text-left">
                                <h1 className="text-3xl font-bold text-gray-800">{userProfile?.companyName || 'Sheba Hospital'}</h1>
