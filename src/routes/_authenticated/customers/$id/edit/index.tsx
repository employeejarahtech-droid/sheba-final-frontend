...
import { useGetCustomerByIdQuery, useUpdateCustomerMutation } from "@/features/customers/api/queries";
...
export default function EditCustomerPage() {
    ...
    const { data: customerResponse, isLoading: isFetching } = useGetCustomerByIdQuery(customerId);
    ...
    useEffect(() => {
        if (customerResponse?.data) {
            ...
            reset({
                name: c.name || "",
                company: c.company || "",
                customer_type: (c.customer_type as "individual" | "business" | "retail") || "individual",
                tax_id: c.tax_id || "",
                email: c.email || "",
                phone: c.phone || "",
                address: c.address || "",
                ...
                gallery_items: c.gallery_items || [],
                salesRouteId: c.sales_route_id ? String(c.sales_route_id) : '',
            });
        }
    ...
    const onSubmit: SubmitHandler<CustomerFormValues> = async (values) => {
        try {
            ...
            updateCustomer({ id: customerId, body: payload }, {
                onSuccess: () => {
                ...
                <div className="space-y-6 max-w-5xl mx-auto pb-6">
                    <div className="flex flex-wrap justify-between items-start gap-4 mb-4">
                        <div>
                            ...
                            <p className="text-muted-foreground mt-2">Update customer details</p>
                        </div>
                        <BackButton />
                    </div>
