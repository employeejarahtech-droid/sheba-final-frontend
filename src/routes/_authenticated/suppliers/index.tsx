...
import { Edit, PlusCircle, Trash2, CheckCircle, Truck, XCircle, Users as UsersIcon, ShoppingCart, Eye } from "lucide-react";
...
function ConfirmModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl w-96 border border-border">
...
function SuppliersList() {
    ...
    const currency = "BDT"; // Fixed currency
    ...
    const allSuppliers: Supplier[] = allSuppliersData?.data || [];
            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="flex gap-2">
                        ...
                        <Link to="/suppliers/$id" params={{ id: supplier.id.toString() }}>
                            <Button size="sm" variant="outline" title="View Details">
                                <Eye className="w-4 h-4 mr-1" /> View
                            </Button>
                        </Link>
                        {/* Placeholder links for now since routes do not exist yet */}
                        <Link to="/suppliers/$id/edit" params={{ id: supplier.id.toString() }}>
