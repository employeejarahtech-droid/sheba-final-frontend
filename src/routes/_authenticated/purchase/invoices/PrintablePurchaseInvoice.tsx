...
import type { PurchaseInvoice, PurchaseOrderItem as POItem } from "@/features/purchase/api/purchaseQueries";
import type { Settings } from "@/features/purchase/api/queries";

interface Props {
    invoice: PurchaseInvoice | undefined;
    from: { name: string; email?: string; phone?: string; address?: string } | undefined;
                    ...
                    <div className="w-64 ml-auto space-y-2 text-sm">
                        <div className="flex justify-between">
                            ...
                            <span className="font-semibold">
                                {currency} {Number(invoice?.purchase_order?.total_amount)?.toFixed(2)}
                            </span>
                        </div>
