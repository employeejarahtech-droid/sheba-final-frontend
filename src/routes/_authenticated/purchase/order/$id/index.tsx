...
export const Route = createFileRoute('/_authenticated/purchase/order/$id/')({
...
export default function PurchaseOrderView() {
    ...
    const { data: poWrapper, isLoading } = useGetPurchaseOrderByIdQuery(id);
    const purchase = poWrapper?.data;

    const { mutate: updateOrder, isPending: isUpdating } = useUpdatePurchaseOrderMutation();
    const { mutate: createInvoice, isPending: isCreating } = useCreatePurchaseInvoiceMutation();
    ...
    const handleApprove = async () => {
        updateOrder({
            ...
            onSuccess: () => toast.success("Purchase Order Approved Successfully"),
    ...
    const handleCreateInvoice = async () => {
        createInvoice({
            ...
            onSuccess: () => {
                ...
                updateOrder({ id: purchase.id, body: { status: 'received' } });
            },
                ...
                <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in-50 duration-500 pb-10">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            <div className="flex items-center gap-2 text-sm text-muted-foreground mb-1">
                                <Link to="/purchase/order" className="hover:text-primary transition-colors flex items-center gap-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            {["approved", "received", "delivered"].includes(purchase.status || "") && (
                                purchase.invoice ? (
                                    <Button variant="outline" className="gap-2 shadow-sm" onClick={() => toast.info("Invoice viewing coming soon")}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        <div className="lg:col-span-8 space-y-6">
                            ...
                            {/* 3. Items Table */}
                            <Card className="shadow-sm border-border/60 overflow-hidden pt-0">
                        ...
                        <div className="lg:col-span-4 space-y-6">
                            ...
                            {/* SUMMARY */}
                            <Card className="shadow-md border-border/60 bg-slate-50 dark:bg-slate-900 overflow-hidden pt-0">
                                <div className="h-2 bg-gradient-to-r from-blue-500 to-indigo-600"></div>
                                <CardHeader className="pb-4 border-b-1 gap-0">
