...
export const Route = createFileRoute('/_authenticated/purchase/order/$id/edit')({
...
export function EditPurchaseOrderPage() {
    ...
    const { data: poData, isLoading: poLoading } = useGetPurchaseOrderByIdQuery(id);
        ...
        if (poData?.data) {
            ...
            reset({
                ...
                items: (po.items || []).map((item: any) => ({
                    ...
                    purchase_tax: item.purchase_tax || 0,
                })),
            });
        }
    }, [poData, reset]);
    ...
    const onSubmit = async (values: PurchaseOrderFormValues) => {
        try {
            ...
            await updatePurchaseOrder.mutateAsync({ id: Number(id), body: payload });
                ...
                <div className="space-y-6 max-w-5xl w-full mx-auto">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-muted-foreground mt-2">Update purchase order #{poData?.data?.po_number}</p>
                        </div>
                        <BackButton />
                    </div>
                                ...
                                <CardHeader className="bg-gradient-to-r from-blue-50 via-indigo-50 to-blue-50 dark:from-blue-950/30 dark:via-indigo-950/30 dark:to-blue-950/30 border-b-1 border-blue-100 dark:border-blue-900 py-3 gap-0">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-sm text-gray-600 dark:text-gray-400 mt-0.5">Edit supplier or order dates</p>
                                        </div>
                                    </div>
                                </CardHeader>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-sm text-gray-600 dark:text-gray-400 mt-0.5">Manage products in this purchase order</p>
                                            </div>
                                        </div>
                                        <button
                                            type="button"
