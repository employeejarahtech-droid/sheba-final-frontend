...
import { useGetExpenseHeadsQuery, useGetAccountingAccountsQuery, useAddExpenseHeadwiseMutation } from "@/features/accounting/accountingQueries";
...
export default function AddExpensePage() {
  ...
  const addExpense = useAddExpenseHeadwiseMutation();
  const isLoading = addExpense.isPending;
  ...
  // TODO: Add currency selector when store is available
  const currency = "USD";
