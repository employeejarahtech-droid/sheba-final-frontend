        ...
        <div className="w-full rounded-xl mx-auto">
            ...
            <div className="flex gap-4 mb-4">
                ...
                <div className="flex-1">
                    ...
                    <div className="bg-gray-50 p-2 rounded-md border border-gray-200 text-sm">{invoiceInfo.patientName ?? "-"}</div>
                </div>
            </div>
            ...
            <div className="flex gap-4 mb-4">
                <div className="flex-1">
                    ...
                    <div className="bg-gray-50 p-2 rounded-md border border-gray-200 text-sm">{invoiceInfo.age ?? "-"}</div>
                </div>

                <div className="flex-1">
                    <div className="text-sm text-gray-600 mb-1">Gender</div>
                    <div className="bg-gray-50 p-2 rounded-md border border-gray-200 text-sm">{invoiceInfo.gender ?? "-"}</div>
                </div>
            </div>
