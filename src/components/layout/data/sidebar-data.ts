      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { title: 'Discharged Patients', url: '/dashboard/admission/patients/discharged', icon: LogOut },
        ...
        },
        {
          ...
          items: [
            ...
            { title: 'Discharge List', url: '/dashboard/admission/patients/discharged-list', icon: LogOut },
            { title: 'Payment Completed', url: '/dashboard/admission/patients/payment-completed-list', icon: CheckCircle2 },
            { title: 'Bills Distributed', url: '/dashboard/admission/patients/bill-distributed-list', icon: TrendingUp },
            { title: 'Balance & Finish', url: '/dashboard/admission/patients/balance-distributed-list', icon: Scale },
            { title: 'Doctor Referred', url: '/dashboard/indoor/management/doctor-referred', icon: UserCog },
            { title: 'Doctor Bill', url: '/dashboard/indoor/management/doctor-bill', icon: DollarSign },
            ...
            { title: 'Other Bills', url: '/dashboard/indoor/management/other-bills', icon: DollarSign },
          ],
        },
      ],
    },
