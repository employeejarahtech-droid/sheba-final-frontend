...
export default function OperationTypes() {
    ...
    const { data } = useQuery({
        queryKey: ["operation-types", page, search],
        queryFn: async () => {
    ...
    const columns = [
        ...
        },
        {
            data: null,
            title: "Actions",
            render: (data: any, type: string, row: OperationTypeItem) => {
                return `
    ...
    useEffect(() => {
        const handleExpandClick = (e: Event) => {
            ...
            details.innerHTML = `
                <li><strong>Operation Type ID:</strong> ${id}</li>
        ...
        <Main className="p-6 lg:p-10">
            <div className="space-y-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-2">
                    <h1 className="text-2xl font-bold tracking-tight">List of Operation Types</h1>
