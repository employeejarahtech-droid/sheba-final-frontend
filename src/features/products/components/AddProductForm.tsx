...
// import ImageUploaderPro from "@/components/form/ImageUploaderPro"; // Assuming this path is correct relative to imports
            ...
            <main className="p-6 lg:p-10 max-w-5xl w-full mx-auto">
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">Create a new product with details</p>
                    </div>
                    <BackButton />
                </div>
                <div className="">
                    <Form {...form}>
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <Card className="overflow-hidden border-2 transition-all duration-300 hover:border-blue-200 hover:shadow-lg pt-0">
                                ...
                                <CardContent className="grid gap-4 md:grid-cols-2 pb-3 items-start">
                                    {/* SKU */}
                                    <Controller
                                        control={control}
                                        name="sku"
                            ...
                            <Card className="overflow-hidden border-2 transition-all duration-300 hover:border-blue-200 hover:shadow-lg pt-0">
                                ...
                                <CardContent className="grid gap-4 md:grid-cols-3 pb-6 items-start">
                                    {/* CATEGORY */}
                                    <Controller
                                        control={control}
                                        name="category"
                                                        ...
                                                        <PopoverContent className="w-full p-0">
                                                            <Command>
                                                                ...
                                                                <CommandList>
                                                                    ...
                                                                    <CommandGroup>
                                                                        {units.map((unit: Unit) => {
                                                                            // if (!unit.is_active) return // Removed check as mock data might not have it set on all, or logic in generic.
                                                                            return (
                                                                                <CommandItem
                                                                                    key={unit.id}
                            ...
                            <Button type="submit" className="w-full h-12 text-lg font-medium bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 shadow-lg shadow-blue-500/25 transition-all duration-300 transform active:scale-[0.98]" disabled={isAdding}>
