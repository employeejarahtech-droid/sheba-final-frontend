...
import { useCreateCategoryMutation, useUpdateCategoryMutation } from '@/features/assets/assetQueries'
...
const BACK = '/dashboard/assets/categories'

export function CategoryForm({ initial }: { initial?: AssetCategory }) {
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 w-full max-w-[750px] mx-auto px-4">
            <div className="flex items-center gap-4 mb-2">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Classify assets into groups</p>
              </div>
            </div>
              ...
              <CardContent className="p-4 space-y-4">
                <FormField control={form.control} name="name" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input placeholder="e.g. Medical Equipment" {...field} /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
