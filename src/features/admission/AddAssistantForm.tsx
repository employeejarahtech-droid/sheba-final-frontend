...
import { CalendarIcon, Check, ChevronDown, UserCheck } from 'lucide-react'
...
export function AddAssistantForm({ open, setOpen, onAdd, doctors, editAssistant }: AddAssistantFormProps) {
    ...
    useEffect(() => {
        ...
        setAssistantOpen(false) // Close dropdown when opening or changing edit mode
    }, [editAssistant, form])
            ...
            <SheetContent side="right" className="max-w-[450px] w-full">
                <SheetHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border-b py-3 px-4 gap-0">
                    <div className="flex items-center gap-2.5 pr-8">
                        ...
                        <div>
                            <SheetTitle className="text-lg font-bold">{editAssistant ? 'Edit Assistant' : 'Add Assistant'}</SheetTitle>
