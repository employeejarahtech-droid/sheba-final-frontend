...
export default function Departments({ page, limit, search, setPage, setLimit, setSearch }: DepartmentsProps) {
    ...
    const can = useCan();
    const canEdit = can('outdoor.master.departments.edit');
    const canDelete = can('outdoor.master.departments.delete');
                ...
                <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-8 flex justify-end gap-3 border-t pt-5">
                            ...
                            ${canEdit ? `<button onclick="window.editDepartment('${id.replace(/'/g, "\\'")}')"
            ...
            render: (_data: any, _type: string, row: DepartmentItem) => {
                return `
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        ${canEdit ? `<button onclick="window.editDepartment('${row.id}')" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded text-xs font-semibold shadow transition-colors">
                        ...
                        ${canDelete ? `<button onclick="window.deleteDepartment('${row.id}')" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-red-600 hover:bg-red-700 text-white rounded text-xs font-semibold shadow transition-colors">
