...
export default function BloodForBtctReportDetails({ invoice: invoice, testName, paddingTop = 40, fontSize = 1, showSignature = true }: BloodForBtctReportDetailsProps) {
      ...
      <table className="w-full text-sm mt-6">
        ...
        <tbody>
          <tr className="border-b border-dashed">
            <td className="px-3 py-2">Bleeding Time (BT)</td>
            <td className="px-3 py-2">{invoice.bleeding_time || 'N/A'} minutes</td>
            <td className="px-3 py-2">1-3 minutes</td>
          </tr>
          <tr className="border-b border-dashed">
            <td className="px-3 py-2">Clotting Time (CT)</td>
            <td className="px-3 py-2">{invoice.clotting_time || 'N/A'} minutes</td>
            <td className="px-3 py-2">4-9 minutes</td>
          </tr>
        </tbody>
      </table>
