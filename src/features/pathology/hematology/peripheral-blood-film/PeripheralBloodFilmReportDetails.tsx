...
interface PeripheralBloodFilmReportDetailsProps {
  invoice?: any;
  testName?: string;
  paddingTop?: number;
  fontSize?: number;
...
export default function PeripheralBloodFilmReportDetails({ invoice: invoice, testName, paddingTop = 40, fontSize = 1, showSignature = true }: PeripheralBloodFilmReportDetailsProps) {
