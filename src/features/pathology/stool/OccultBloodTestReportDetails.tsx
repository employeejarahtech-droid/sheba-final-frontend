...
export default function OccultBloodTestReportDetails({ occultBloodData, invoiceData, paddingTop = 40, fontSize = 1, showSignature = true }: OccultBloodTestReportDetailsProps) {
