...
export default function ElectrolytesReportDetails({ electrolytesData, invoiceData }: ElectrolytesReportDetailsProps) {
            ...
            <table className="w-full text-sm mt-6">
                ...
                <tbody>
                    <tr className={`border-b-${borderWidth} border-dashed border-b`}>
                        <td className="px-3 py-2">Sodium (Na⁺)</td>
                        <td className="px-3 py-2">{electrolytesData?.sodium || 'Pending'} mEq/L</td>
                        <td className="px-3 py-2">135-145 mEq/L</td>
                    </tr>
                    <tr className={`border-b-${borderWidth} border-dashed border-b`}>
                        <td className="px-3 py-2">Potassium (K⁺)</td>
                        <td className="px-3 py-2">{electrolytesData?.potassium || 'Pending'} mEq/L</td>
                        <td className="px-3 py-2">3.5-5.5 mEq/L</td>
                    </tr>
                    <tr className={`border-b-${borderWidth} border-dashed border-b`}>
                        <td className="px-3 py-2">Chloride (Cl⁻)</td>
                        <td className="px-3 py-2">{electrolytesData?.chloride || 'Pending'} mEq/L</td>
                        <td className="px-3 py-2">98-107 mEq/L</td>
                    </tr>
                    <tr className={`border-b-${borderWidth} border-dashed border-b`}>
                        <td className="px-3 py-2">Bicarbonate (HCO₃⁻)</td>
                        <td className="px-3 py-2">{electrolytesData?.bicarbonate || 'Pending'} mEq/L</td>
                        <td className="px-3 py-2">22-28 mEq/L</td>
                    </tr>
                    {electrolytesData?.remarks && (
                        <tr className={`border-b-${borderWidth} border-dashed border-b`}>
                            <td className="px-3 py-2">Remarks</td>
                            <td className="px-3 py-2" colSpan={2}>{electrolytesData.remarks}</td>
                        </tr>
                    )}
                </tbody>
            </table>
