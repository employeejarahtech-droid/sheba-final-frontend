...
export default function SkinScrappingForFungusReportDetails({ skinScrappingData, invoiceData, paddingTop = 40, fontSize = 1, showSignature = true }: SkinScrappingForFungusReportDetailsProps) {
