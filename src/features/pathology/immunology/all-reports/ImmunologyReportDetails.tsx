...
export default function ImmunologyReportDetails({ invoice, testName = "IMMUNOLOGY REPORT", paddingTop = 40, fontSize = 1, showSignature = true, columnLayout = DEFAULT_COLUMN_LAYOUT }: ImmunologyReportProps) {
  const patientInfo = invoice?.invoice_information || null;
  const tests = invoice?.immunology_all_info || [];
