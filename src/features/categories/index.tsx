            ...
            render: (_data: any, _type: string, row: CategoryItem) => {
                return `
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <button onclick="window.deleteCategory(${row.id})" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-red-600 hover:bg-red-700 text-white rounded text-xs font-semibold shadow transition-colors">
