...
export default function CreateDoctorPage() {
    ...
    const createMutation = useMutation({
        ...
        onError: (error: Error) => {
            // Don't show toast for 401 - it's handled in authenticatedFetch
                ...
                <div className="space-y-6 max-w-5xl mx-auto">
                    ...
                    <Form {...form}>
                        <form id="create-doctor-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            {/* Personal Info Group */}
                            <Card className="rounded-2xl border shadow-lg shadow-gray-200/50 dark:shadow-none overflow-hidden pt-0">
                            ...
                            <Card className="rounded-2xl border shadow-xl shadow-gray-200/50 dark:shadow-none overflow-hidden pt-0">
                                <CardHeader className="bg-gradient-to-br from-violet-50 to-white dark:from-violet-950/30 dark:to-zinc-900 border-b-1 py-4 gap-0">
                                    <CardTitle className="flex items-center gap-2">
                                        <div className="p-2 rounded-lg bg-violet-100 text-violet-600 dark:bg-violet-900/30 dark:text-violet-400 shadow-inner">
                                            <User className="h-5 w-5" />
                                        </div>
                                        Doctor Type
                                    </CardTitle>
