      ...
      render: (_: any, __: string, row: FinalDistribution, meta: any) => {
        ...
        return `
          <div class="flex items-center gap-2">
            <button
              class="anesthesia-expand-btn inline-flex items-center justify-center w-7 h-7 rounded bg-black text-white hover:bg-gray-800 transition-colors font-bold text-xs"
              type="button"
