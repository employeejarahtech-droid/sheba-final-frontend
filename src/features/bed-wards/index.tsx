...
export default function BedWards({ page, limit, search, setPage, setLimit, setSearch }: BedWardsProps) {
    ...
    const can = useCan();
    const canCreate = can('indoor.master.wards.create');
    const canEdit = can('indoor.master.wards.edit');
    const canDelete = can('indoor.master.wards.delete');
        ...
        <main className="p-4">
            <div className="space-y-4">
                ...
                <PageHeader
                    ...
                    actions={canCreate ? <CreateBedWardForm /> : null}
                />
                <DataTable
                    columns={columns}
